...
<script type="text/javascript">  
        function validate(){  
            ...
            var newword=valueOf(document.getElementById("newword"));  
            if(username==""){  
                alert("用户名不能为空!");  
...
<body>
	<center>
		...
		<form action="/library/user/registeruser" method="post">
			<table width="300" height="180" border="5" bordercolor="#A0A0A0">
				...
				<tr>
					<th>确认密码：</th>
					<td><input type="text" name="newword" value="重新输入密码"
						maxlength="20" onfocus="if(this.value == '重新输入密码') this.value =''">
					</td>
				</tr>
				<tr>
